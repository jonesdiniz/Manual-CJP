...
\begin{itemize}
    \item Agente é ruído, biológico, cancerígeno ou periculosidade? → EPI não afasta
    \item Outros agentes? → Ônus do segurado provar ineficácia
    \item Em caso de dúvida → Favorável ao segurado
\end{itemize}
\end{novidade}
...
\begin{itemize}
    \item[$\square$] Delimitar período rural (início trabalho até 1º emprego urbano)

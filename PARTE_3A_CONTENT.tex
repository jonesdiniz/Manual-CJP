...
\begin{enumerate}
    ...
    \item Se indeferido → Recurso à CRPS ou Ação Judicial
\end{enumerate}
...
\begin{itemize}
    ...
    \item[$\square$] Houve ``mudança de regime'' (CLT → estatutário) com saque
\end{itemize}
...
\textbf{Lei 8.213/91, art. 55 | CF/88, art. 40, §9º}
...
\begin{itemize}
    ...
    \item \textbf{Tempo público:} Solicitar CTC ao órgão de origem → Averbar no RGPS
\end{itemize}
...
\textbf{III.} Em caso de DÚVIDA sobre eficácia → Conclusão FAVORÁVEL ao segurado
\end{novidade}

...
\textbf{Impacto:} +R\$ 500,00 a +R\$ 2.000/mês para quem tinha 2+ vínculos
...
\textbf{Impacto:} +R\$ 200,00 a +R\$ 800/mês para benefícios de 1988-2003
...
\textbf{Impacto:} +R\$ 500,00 a +R\$ 2.500/mês para benefícios no período
...
\begin{teseRejeitada}
\textbf{TEMA 1300 STF --- AIP com Coeficiente 100\% (REJEITADA --- 6$\times$5)}
...
\begin{itemize}
    ...
    \item[\cmark] Estratégia alternativa: Nexo causal (B32 $\rightarrow$ B92)
\end{itemize}
\end{teseRejeitada}
...
\begin{novidade}
\textbf{ACP 5020446-70/ES + Portaria 87/2023 --- DII Única (EM VIGOR)}

\textbf{Status:} Liminar vigente (tutela de urgência deferida)

\textbf{O que é:} Conversão de Auxílio Temporário em AIP com DII pré-Reforma (anterior a 13/11/2019) deve usar cálculo de 100\% da média dos 80\% maiores salários.

\textbf{Fundamento:} Princípio \textit{tempus regit actum} --- o fato gerador único (DII) atrai a lei vigente à época.

\textbf{Impacto:} +30\% a +40\% na RMI (de 60\% para 100\%)

\textbf{Aplicável a:} Conversões AIT $\rightarrow$ AIP com DII anterior a 13/11/2019

\textbf{Cautela:} A decisão judicial é \textbf{liminar} (não definitiva). A Portaria 87/2023 está vigente e suspende cobranças.

\textbf{Taxa de êxito:} 85\%+ (administrativa com base na Portaria)
\end{novidade}
...
\hline
ACP DII Única (Port. 87) & \cmark\ Liminar & Alto & Administrativa/Judicial \\
\hline
\end{tabular}
\end{center}

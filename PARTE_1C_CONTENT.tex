...
Se você não juntar todos os documentos no PA, a DIB pode ser fixada na CITAÇÃO, não na DER — e seu cliente perde MESES ou ANOS de atrasados!
\end{novidade}
...
\textbf{EXCEÇÃO:} Se o documento era IMPOSSÍVEL de obter na via administrativa (ex: empresa falida sem PPP), a DIB pode ser fixada posteriormente.
\end{estrategiaCJP}
...
\begin{itemize}
    ...
    \item \textbf{Atrasados perdidos:} 6 meses $\times$ R\$ 3.500,00 = \textbf{R\$ 21.000}
\end{itemize}
...
\textbf{ETAPA 0: VERIFICAÇÃO INICIAL (2026)}
\begin{itemize}
...
\textbf{ETAPA 1: PREPARAÇÃO DA ENTREVISTA}
\begin{itemize}
...
\textbf{ETAPA 4: SOLICITAR DOCUMENTAÇÃO}
\begin{itemize}
...
\textit{André:} ``Eu ganhava salário fixo de R\$ 2.200,00 + comissão sobre vendas. A comissão variava, mas todo mês eu recebia. Na média dava uns R\$ 2.500/mês de comissão.''
...
\textbf{Ganho financeiro:}
\begin{itemize}
    \item Diferenças retroativas: 60 meses $\times$ R\$ 1.750,00 = \textbf{R\$ 105.000}
    \item Ganho vitalício (20 anos): R\$ 1.750,00 $\times$ 12 $\times$ 20 = \textbf{R\$ 420.000}
\end{itemize}
...
\textbf{ETAPA 0: VERIFICAÇÃO PROCURAÇÃO ELETRÔNICA}
\begin{itemize}
...
\textbf{ETAPA 2: CONDUÇÃO DA ENTREVISTA}
\begin{itemize}
...
\textbf{ETAPA 4: DOCUMENTAÇÃO SOLICITADA}
\begin{itemize}
...
\begin{conceitoChave}
\textbf{A diferença?} Uma entrevista de 1 hora bem feita vale \textbf{R\$ 50.000,00 - R\$ 200.000} em ganho para o cliente.

E isso justifica seus honorários de \textbf{R\$ 1.500,00 - R\$ 3.000} por caso.
\end{conceitoChave}

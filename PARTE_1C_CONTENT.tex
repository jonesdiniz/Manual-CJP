...
\begin{itemize}
    ...
    \item \textbf{Atrasados perdidos:} 6 meses × R\$ 3.500 = \textbf{R\$ 21.000}
\end{itemize}
...
\begin{itemize}
    ...
    \item[$\square$] Se intimou e segurado não complementou → DIB na citação
    \item[$\square$] Se NÃO intimou → interesse de agir configurado → DIB na DER
\end{itemize}
\end{acaoImediata}
...
\textbf{Impacto:}
\begin{itemize}
    \item 12 anos especiais × 1,4 = 16,8 anos comuns
...
\begin{itemize}
    \item Aposentar 2 anos antes = 24 meses × R\$ 4.200
...
\textbf{Ganho financeiro:}
\begin{itemize}
    \item Aposentar 3 anos antes = 36 meses × R\$ 3.800
...
\textbf{Ganho financeiro:}
\begin{itemize}
    \item Diferenças retroativas: 60 meses × R\$ 1.750 = \textbf{R\$ 105.000}
    \item Ganho vitalício (20 anos): R\$ 1.750 × 12 × 20 = \textbf{R\$ 420.000}
\end{itemize}
...
\begin{itemize}
    ...
    \item[$\square$] Se NÃO → Orientar cadastro (enviar roteiro)
    \item[$\square$] Se SIM → Verificar acesso ao CNIS em tempo real
\end{itemize}
...
Recebia o CNIS → calculava → apresentava → honorários medianos

\textbf{DEPOIS do Módulo 1:}\\
Acessa CNIS via procuração → entrevista estrategicamente → descobre 3-5 erros → corrige → calcula com CNIS completo → apresenta ganho vitalício de R\$ 200.000+ → honorários premium

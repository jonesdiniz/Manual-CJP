...
\begin{novidade}
A Portaria Conjunta DIT/DIRBEN/INSS n.\textsuperscript{o} 10/2025 mudou COMPLETAMENTE a forma como você acessa informações do cliente. LEIA ESTA SEÇÃO COM ATENÇÃO MÁXIMA.
\end{novidade}
...
\begin{itemize}
    ...
    \item[\xmark] NÃO permite interpor RECURSO ou MANIFESTAÇÃO
...
\begin{acaoImediata}
Não preencha um formulário. Conduza uma INVESTIGAÇÃO.
...
\textbf{Impacto:} 10 anos $\times$ 1,4 = 14 anos. \textbf{+4 anos de bônus} = Revisão de R\$ 2.800,00 para R\$ 3.650\\
...
\textbf{CNIS:} Dois vínculos simultâneos (Empresa A: R\$ 1.200,00 | Empresa B: R\$ 800)\\

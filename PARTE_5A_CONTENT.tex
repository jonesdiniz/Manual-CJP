...
\begin{itemize}
    \item Salário Mínimo: R\$ 1.621,00 (confirmado)
    \item Teto INSS: R\$ 8.537,55*
\end{itemize}
...
Você calculou R\$ 3.200,00. Ele calculou R\$ 4.800,00.
...
\hline
Cobra R\$ 500-800 & Cobra R\$ 1.500-5.000 (premium) \\
\hline
\end{tabular}
\end{table}
...
\textbf{ROI médio do cliente:} R\$ 50.000-300.000 a mais ao longo da aposentadoria.

Vale a diferença de R\$ 1.000 no honorário?
\end{estrategiaCJP}
...
Você identifica, corrige e salva o cliente de perder R\$ 800/mês.
...
Você mostra NA MATEMÁTICA que ele ganhará R\$ 120.000 a mais na vida.
...
\textbf{Cenário A:} PBC de jul/1994 → hoje (100\% contribuições)\\
→ Média: R\$ 3.800,00

\textbf{Cenário B:} PBC de jul/1994 → hoje (80\% melhores)\\
→ Média: R\$ 5.200,00

Diferença: R\$ 1.400/mês = R\$ 16.800/ano\\
Em 20 anos de aposentadoria: \textbf{R\$ 336.000!}
...
\hline
Era 1 & Lei 8.213/1991 (até EC 103/2019) & Jul/1994 → DER (80\% maiores) & Aposentadorias até 12/11/2019 \\
\hline
Era 2 & EC 103/2019 & Jul/1994 → DER (100\% todos) & Aposentadorias de 13/11/2019 a 08/05/2022 \\
\hline
Era 3 & Lei 14.331/2022 & Jul/1994 → DER (100\% + Divisor 108) & Aposentadorias a partir de 09/05/2022 \\
\hline
\end{tabularx}
\end{table}
...
\hline
DER até 12/11/2019 & Jul/1994 → DER (80\% maiores) \\
\hline
DER de 13/11/2019 a 08/05/2022 + Regra Pedágio 50\%/100\% & Jul/1994 → DER (80\% maiores) \\
\hline
DER de 13/11/2019 a 08/05/2022 + Outras regras & Jul/1994 → DER (100\% + Vácuo) \\
\hline
DER a partir de 09/05/2022 & Jul/1994 → DER (100\% + Divisor 108) \\
\hline
\end{tabular}
\end{center}
...
\begin{itemize}
    \item Jul/1994 → Dez/2019: 300 contribuições no teto (média R\$ 6.000)
    \item Jan/2020 → Jun/2024: 54 contribuições no teto (média R\$ 7.500)
\end{itemize}
...
Soma dos 240 maiores: R$ 1.440.000
SB = R$ 1.440.000 ÷ 240 = R$ 6.000,00
\end{verbatim}
...
Soma de todas: R$ 1.440.000 + R$ 405.000 = R$ 1.845.000
SB = R$ 1.845.000 ÷ 354 = R$ 5.212,00
\end{verbatim}
...
Se Maria pudesse escolher, deveria ter requerido em \textbf{outubro/2019} (antes da Reforma) para garantir o SB de R\$ 6.000.
...
A escolha do MOMENTO de requerer a aposentadoria pode valer R\$ 50.000-150.000 ao longo da vida.
...
Soma: R$ 8.157,41 × 60 = R$ 489.444,60
SB (Vácuo) = R$ 489.444 ÷ 60 = R$ 8.157,41 (TETO!)

Com Lei 14.331 (se aplicasse):
SB = R$ 489.444 ÷ 108 = R$ 4.531,89
\end{verbatim}
...
\textbf{ROI médio:} R\$ 18.000-45.000 em atrasados
...
\hline
Jul/1994 → 12/11/2019 & Quantidade real (80\% maiores) & Lei 9.876/1999 \\
\hline
13/11/2019 → 08/05/2022 & Quantidade real (100\%) & EC 103/2019 \\
\hline
09/05/2022 → Hoje & Máx(Quantidade, 108) & Lei 14.331/2022 \\
\hline
\end{tabular}
\end{center}
...
\textbf{Soma dos salários:} R\$ 420.000,00

\subsubsection{Cenário A: DIB em Janeiro/2021 (Período do Vácuo)}

\begin{verbatim}
SB (Vácuo) = R$ 420.000 ÷ 84 = R$ 5.000,00
Coeficiente (Art. 26, EC 103) = 60% + 2% × (7 - 7) = 60%
RMI (Vácuo) = R$ 5.000 × 0,60 = R$ 3.000,00
\end{verbatim}

\subsubsection{Cenário B: DIB em Junho/2022 (Após Lei 14.331)}

\begin{verbatim}
SB (Lei 14.331) = R$ 420.000 ÷ 108 = R$ 3.888,89
Coeficiente (Art. 26, EC 103) = 60% + 2% × (7 - 7) = 60%
RMI (Lei 14.331) = R$ 3.888 × 0,60 = R$ 2.333,33
\end{verbatim}

...
\begin{itemize}
    \item Jul/1994 $\rightarrow$ Dez/2019: 300 contribuições no teto (média R\$ 6.000)
    \item Jan/2020 $\rightarrow$ Jun/2024: 54 contribuições no teto (média R\$ 7.500)
\end{itemize}
...
RMI (Vácuo) = R$ 5.000 x 0,60 = R$ 3.000,00
\end{verbatim}
...
Coeficiente (Art. 26, EC 103) = 60% + 2% x (7 - 7) = 60%
RMI (Lei 14.331) = R$ 3.888 x 0,60 = R$ 2.333,33
\end{verbatim}

% ============================================================================
% MÃ“DULO 4 - PARTE C: MODELOS RAC E FLUXOGRAMA
% ============================================================================
...
\begin{verbatim}
AO INSTITUTO NACIONAL DO SEGURO SOCIAL â✅ INSS
AGÃŠNCIA: [Nome da Agência ou PROTOCOLO ONLINE]
...
ENDEREÃ‡O: [Rua, Número, Bairro, Cidade/UF, CEP]
...
O(A) requerente vem, respeitosamente, solicitar a RETIFICAÃ‡ÃƒO DO CNIS 
...
2. DOS FATOS E FUNDAMENTAÃ‡ÃƒO LEGAL
...
requerente apresenta OMISSÃ•ES E INCORREÃ‡Ã•ES que precisam ser sanadas.
...
6. RELAÃ‡ÃƒO DE DOCUMENTOS ANEXOS
...
- Tema 1090 do STJ: Ã”nus da prova sobre EPI favorece segurado
...
Requer o RECONHECIMENTO DE TEMPO DE SERVIÃ‡O RURAL em regime de 
...
c) Caso necessário, a designação de AUDIÃŠNCIA DE JUSTIFICAÃ‡ÃƒO 
...
\textbf{ETAPA 3: ORGANIZAR DOSSIÃŠ}\\
...
\begin{conceitoChave}
\textbf{DECISÃ•ES POSSÍVEIS APÃ“S ANÁLISE:}
...
$\rightarrow$ NÃƒO: Considerar via judicial
\end{conceitoChave}

\begin{armadilha}
\textbf{ATENÃ‡ÃƒO: PRAZOS CRÍTICOS}

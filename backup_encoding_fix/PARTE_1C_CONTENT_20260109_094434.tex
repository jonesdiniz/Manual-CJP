...
\begin{itemize}
    ...
    \item \textbf{Atrasados perdidos:} 6 meses $\times$ R\$ 3.500,00 = \textbf{R\$ 21.000,00}
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Atrasados garantidos:} R\$ 21.000,00 \textbf{preservados}
\end{itemize}
...
\begin{itemize}
    \item Aposentar 2 anos antes = 24 meses $\times$ R\$ 4.200,00
    \item \textbf{Ganho imediato: R\$ 100.800,00}
\end{itemize}
...
\textbf{Ganho financeiro:}
\begin{itemize}
    \item Aposentar 3 anos antes = 36 meses $\times$ R\$ 3.800,00
    \item \textbf{Ganho: R\$ 136.800,00}
\end{itemize}
...
\begin{itemize}
    ...
    \item RMI atual: R\$ 2,00.600,00
    \item CNIS: Salário registrado R\$ 2.200,00/mês
\end{itemize}
...
\textit{André:} ``Eu ganhava salário fixo de R\$ 2.200,00 + comissão sobre vendas. A comissão variava, mas todo mês eu recebia. Na média dava uns R\$ 2.500,00/mês de comissão.''

\textbf{Descoberta:}\\
O INSS considerou apenas o salário fixo (R\$ 2.200,00) no cálculo do PBC, ignorando as comissões habituais.

\textbf{Documentação Obtida:}\\
60 contracheques (2015-2020) mostrando:
\begin{itemize}
    \item Salário fixo: R\$ 2.200,00/mês
    \item Comissão média: R\$ 2.480,00/mês
    \item \textbf{Salário total médio:} R\$ 4.680,00/mês
\end{itemize}

\textbf{Impacto:}
\begin{itemize}
    \item PBC recalculado com salário total
    \item Nova RMI: R\$ 4.350,00 (vs R\$ 2.600,00 atual)
    \item \textbf{Aumento:} +R\$ 1.750,00/mês
\end{itemize}

\textbf{Ganho financeiro:}
\begin{itemize}
    \item Diferenças retroativas: 60 meses $\times$ R\$ 1.750,00 = \textbf{R\$ 105.000,00}
    \item Ganho vitalício (20 anos): R\$ 1.750,00 $\times$ 12 $\times$ 20 = \textbf{R\$ 420.000,00}
\end{itemize}
...
\begin{itemize}
    ...
    \item[\cmark] 3 casos reais onde a entrevista gerou ganhos de R\$ 100.000,00+
\end{itemize}
...
Acessa CNIS via procuração $\rightarrow$ entrevista estrategicamente $\rightarrow$ descobre 3-5 erros $\rightarrow$ corrige $\rightarrow$ calcula com CNIS completo $\rightarrow$ apresenta ganho vitalício de R\$ 200.000,00+ $\rightarrow$ honorários premium

\begin{conceitoChave}
\textbf{A diferença?} Uma entrevista de 1 hora bem feita vale \textbf{R\$ 50.000,00 - R\$ 200.000,00} em ganho para o cliente.

E isso justifica seus honorários de \textbf{R\$ 1.500,00 - R\$ 3.000,00} por caso.
\end{conceitoChave}

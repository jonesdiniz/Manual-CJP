...
% ============================================================================
% MÃ“DULO 9 - PARTE B: MODELOS, QUESITOS E FINALIZAÃ‡ÃƒO
% ============================================================================
...
\begin{verbatim}
REQUERIMENTO DE CONCESSÃƒO DE BENEFÍCIO PREVIDENCIÁRIO
APOSENTADORIA {POR IDADE | POR TEMPO DE CONTRIBUIÃ‡ÃƒO | ESPECIAL}
...
ASSUNTO: REQUERIMENTO DE CONCESSÃƒO DE APOSENTADORIA {POR IDADE | POR TEMPO 
DE CONTRIBUIÃ‡ÃƒO | ESPECIAL} - {REGRA PERMANENTE | REGRA DE TRANSIÃ‡ÃƒO [ESPECIFICAR]}
...
DE CONTRIBUIÃ‡ÃƒO | ESPECIAL}, pela {REGRA PERMANENTE | REGRA DE TRANSIÃ‡ÃƒO 
[NOME]}, nos termos da legislação previdenciária vigente.

I.1 - DO HISTÃ“RICO CONTRIBUTIVO

Conforme extrato do CNIS atualizado (Anexo I), o(a) Requerente possui o 
seguinte histórico contributivo:

RESUMO DO TEMPO DE CONTRIBUIÃ‡ÃƒO:
â• Tempo Total de Contribuição: [XX] anos, [XX] meses e [XX] dias
â• Tempo de Contribuição até 12/11/2019: [XX] anos, [XX] meses e [XX] dias
â• Tempo de Contribuição após 13/11/2019: [XX] anos, [XX] meses e [XX] dias
â• Carência: [XXX] contribuições mensais

(SE HOUVER TEMPO ESPECIAL)
â• Tempo Especial (antes de 13/11/2019): [XX] anos, [XX] meses
â• Tempo Especial convertido em comum: [XX] anos, [XX] meses

(SE HOUVER TEMPO RURAL)
â• Tempo Rural: [XX] anos, [XX] meses
...
OPÃ‡ÃƒO A - APOSENTADORIA POR IDADE (REGRA PERMANENTE - EC 103/2019)

Requisitos (Art. 19, EC 103/2019):
âœ… Idade mínima: 65 anos (homem) / 62 anos (mulher)
   Idade do(a) Requerente: [XX] anos (data de nascimento: [DD/MM/AAAA])

âœ… Tempo mínimo de contribuição: 15 anos (mulher) / 20 anos (homem)
   Tempo do(a) Requerente: [XX] anos, [XX] meses

âœ… Carência mínima: 180 contribuições mensais
   Carência do(a) Requerente: [XXX] contribuições

---

OPÃ‡ÃƒO B - APOSENTADORIA POR TEMPO DE CONTRIBUIÃ‡ÃƒO - REGRA DE PONTOS 
(Art. 15, EC 103/2019)

Requisitos:
âœ… Tempo mínimo de contribuição: 35 anos (homem) / 30 anos (mulher)
   Tempo do(a) Requerente: [XX] anos, [XX] meses

âœ… Pontuação mínima: [XXX] pontos em [ANO ATUAL]
   (Tabela progressiva: 2024 = 100H/90M; 2025 = 101H/91M; etc.)
   
   Pontuação do(a) Requerente:
   â• Idade: [XX] anos = [XX] pontos
   â• Tempo de contribuição: [XX] anos = [XX] pontos
   â• TOTAL: [XXX] PONTOS âœ…

âœ… Carência: 180 contribuições mensais
   Carência do(a) Requerente: [XXX] contribuições

---

OPÃ‡ÃƒO C - APOSENTADORIA POR TEMPO DE CONTRIBUIÃ‡ÃƒO - REGRA DO PEDÁGIO 50% 
(Art. 17, EC 103/2019)

Requisitos (cumulativos):
âœ… Faltavam no máximo 2 anos para completar 35/30 anos em 13/11/2019
   Situação do(a) Requerente em 13/11/2019: [XX] anos, [XX] meses
   Faltavam: [X] anos, [XX] meses âœ…

âœ… Cumprimento do pedágio de 50% do tempo faltante
   Tempo faltante em 13/11/2019: [X] anos, [XX] meses = [XX] meses
   Pedágio 50%: [XX] meses $\times$ 0,5 = [XX] meses
   Tempo trabalhado após 13/11/2019: [XX] meses âœ…

âœ… Tempo total mínimo: 35 anos (homem) / 30 anos (mulher)
   Tempo total do(a) Requerente: [XX] anos, [XX] meses âœ…

âœ… Carência: 180 contribuições
   Carência do(a) Requerente: [XXX] contribuições âœ…

---

OPÃ‡ÃƒO D - APOSENTADORIA POR TEMPO DE CONTRIBUIÃ‡ÃƒO - REGRA DO PEDÁGIO 100% 
(Art. 20, EC 103/2019)

Requisitos (cumulativos):
âœ… Idade mínima: 60 anos (homem) / 57 anos (mulher)
   Idade do(a) Requerente: [XX] anos âœ…

âœ… Tempo mínimo: 35 anos (homem) / 30 anos (mulher)
   Tempo do(a) Requerente: [XX] anos, [XX] meses âœ…

âœ… Cumprimento do pedágio de 100% do tempo faltante em 13/11/2019
   Tempo faltante em 13/11/2019: [X] anos, [XX] meses = [XX] meses
...
OPÃ‡ÃƒO E - APOSENTADORIA POR TEMPO DE CONTRIBUIÃ‡ÃƒO - REGRA PERMANENTE 
...
âœ… Tempo mínimo: 20 anos (homem) / 15 anos (mulher)
   Tempo do(a) Requerente: [XX] anos, [XX] meses âœ…
...
OPÃ‡ÃƒO F - APOSENTADORIA ESPECIAL (Art. 19, EC 103/2019)

Requisitos (cumulativos):
âœ… Tempo especial mínimo: {15 | 20 | 25} anos de exposição
   Tempo especial do(a) Requerente: [XX] anos, [XX] meses âœ…

âœ… Idade mínima: {55 | 58 | 60} anos (conforme tempo especial)
   Idade do(a) Requerente: [XX] anos âœ…

âœ… Carência: 180 contribuições
   Carência do(a) Requerente: [XXX] contribuições âœ…

âœ… Comprovação de exposição a agentes nocivos:
...
â• Lei n\textsuperscript{o} 8.213/91 (Lei de Benefícios da Previdência Social)
â• Emenda Constitucional n\textsuperscript{o} 103/2019 (Reforma da Previdência)
â• Art. {ARTIGO ESPECÍFICO} da EC 103/2019
â• Instrução Normativa PRES/INSS n\textsuperscript{o} 128/2022
...
2. COEFICIENTE DE CÁLCULO:
   ...
   â• Base: 60% + 2% por ano acima de {20 anos (homem) / 15 anos (mulher)}
   â• Tempo do(a) Requerente: [XX] anos
   â• Tempo excedente: [XX] anos
   â• Coeficiente: 60% + ([XX] $\times$ 2%) = [XX]%
   
   OU
   
   PARA PEDÁGIO 50%:
   â• 100% do PBC (sem redutor) - Art. 17, \S 2\textsuperscript{o}, EC 103/2019
   â• Coeficiente: 100%
   
   OU
   
   PARA APOSENTADORIA ESPECIAL:
   â• 60% + 2% por ano acima de {15 | 20} anos
   â• Tempo especial: [XX] anos
   â• Coeficiente: 60% + ([XX] $\times$ 2%) = [XX]%
...
\begin{verbatim}
REQUERIMENTO DE REVISÃƒO DE BENEFÍCIO PREVIDENCIÁRIO

REQUERENTE: [NOME COMPLETO DO CLIENTE]
CPF: [XXX.XXX.XXX-XX]
Número do Benefício (NB): [XXX.XXX.XXX-X]
Espécie do Benefício: [CÃ“DIGO] - {APOSENTADORIA | PENSÃƒO | AUXÍLIO}
...
ASSUNTO: REQUERIMENTO DE REVISÃƒO DE BENEFÍCIO - {TEMA 1070 STJ | TEMA 555 
...
[DD/MM/AAAA], vem, por meio de seu(sua) advogado(a), requerer a REVISÃƒO 
...
â• Data de Início do Benefício (DIB): [DD/MM/AAAA]
â• Renda Mensal Inicial (RMI): R$ [XXXX,XX]
â• Período Básico de Cálculo (PBC): R$ [XXXX,XX]
â• Coeficiente aplicado: [XX]%
â• Tempo de contribuição computado: [XX] anos, [XX] meses

I.2 - DO ERRO IDENTIFICADO

Após análise técnica detalhada do processo de concessão, identificou-se 
{ERRO MATERIAL NO CÁLCULO | APLICAÃ‡ÃƒO INCORRETA DA LEGISLAÃ‡ÃƒO}, 
...
OPÃ‡ÃƒO A - TEMA 1070 STJ (ATIVIDADES CONCOMITANTES)
...
a) CONHEÃ‡A e PROCESSE o presente pedido de REVISÃƒO;
...
\begin{acaoImediata}
\textbf{QUESITOS PARA PERÍCIA --- EXPOSIÃ‡ÃƒO A CALOR}
...
\begin{enumerate}
    ...
    \item Qual a temperatura média (IBUTG --- Índice de Bulbo Ãšmido Termômetro de Globo) no ambiente de trabalho?
    ...
    \item \textbf{(CONCLUSÃƒO)} O período deve ser reconhecido como tempo especial?
\end{enumerate}
\end{acaoImediata}
...
\begin{enumerate}
    ...
    \item \textbf{(CONCLUSÃƒO)} O período de [DATA] a [DATA] enquadra-se como atividade especial por categoria profissional?
\end{enumerate}
\end{acaoImediata}
...
\begin{estrategiaCJP}
\textbf{VOCÃŠ COMPLETOU O SISTEMA CJP!}
...
Aplique o Sistema CJP no seu PRÃ“XIMO cliente e veja a diferença na sua receita e na satisfação do cliente.
\end{estrategiaCJP}

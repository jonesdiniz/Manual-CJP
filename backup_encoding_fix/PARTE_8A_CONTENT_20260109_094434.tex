...
\begin{itemize}
    ...
    \item Como justificar R\$ 1.500,00-15.000
\end{itemize}
...
\begin{itemize}
    ...
    \item Quantificou ganho (R\$ 1.200,00/mês)
...
\begin{itemize}
    \item Valor percebido pelo cliente: R\$ 300,00-500
...
\begin{itemize}
    \item Valor percebido pelo cliente: R\$ 3.000,00-8.000
...
\textbf{CORRETO:} ``Dr. João, pegamos seus 80\% melhores salários desde 1994. Fizemos a média. Deu R\$ 4.500,00. Seu benefício final: R\$ 3.870,00/mês.''
\end{armadilha}
...
\hline
\textbf{BLOCO 4: A RECOMENDAÇO} & ``Este é o caminho que recomendo'' (Decisão)\\

...
FÓRMULA:
RMI = Base × (50% + 10% × número de dependentes)
\end{verbatim}
...
Cálculo:
Coeficiente = 50% + (3 × 10%) = 80%
RMI = R$ 6.000 × 0,80 = R$ 4.800,00
...
\textbf{Fundamento:} Art. 23, §2º, EC 103/2019

\textbf{Ganho médio:} R\$ 1.000 a R\$ 2.500/mês\\
...
A Lei 15.108/2025 alterou o Art. 16, §2º da Lei 8.213/91 para equiparar expressamente o \textbf{menor sob guarda judicial} a filho biológico para fins previdenciários.
...
\begin{itemize}
    ...
    \item[\xmark] Menor sob GUARDA → NÃO era dependente automático
\end{itemize}
...
\begin{itemize}
    ...
    \item[\cmark] Enteado até 21 anos
    \item[\cmark] Menor sob TUTELA
    \item[\cmark] \textbf{Menor sob GUARDA JUDICIAL} ← NOVO!
\end{itemize}
\end{novidade}
...
\begin{itemize}
    ...
    \item Segurado tinha aposentadoria de R\$ 5.000/mês
...
Pensão Total: R$ 5.000 × 80% = R$ 4.000
...
Pensão Total: R$ 5.000 × 90% = R$ 4.500
Por dependente: R$ 4.500 ÷ 4 = R$ 1.125,00
\end{verbatim}

\textbf{ANÁLISE:}
\begin{itemize}
    \item Pensão TOTAL aumentou: R\$ 500/mês (+12,5\%)
    \item Cota INDIVIDUAL diminuiu: -R\$ 208,33/pessoa (-15,6\%)
    \item Mas a FAMÍLIA recebe mais no total
    \item Menor sob guarda agora recebe: R\$ 1.125/mês (antes R\$ 0)
\end{itemize}
\end{estrategiaCJP}
...
\textbf{Fundamento:} Lei 15.108/2025 c/c Art. 16, §2º, Lei 8.213/91

\textbf{Ganho médio:} +10\% no coeficiente (R\$ 300-800/mês)\\
...
Exemplo (MEI):
• Contribuições: R$ 1.621,00 (salário mínimo) × 12 meses
• Soma: R$ 19.452
...
\textbf{Valor médio:} R\$ 1.621 a R\$ 3.500/mês × 4-5 meses (120-150 dias)\\
...
\begin{itemize}
    ...
    \item Diária: R\$ 3.500 ÷ 30 = R\$ 116,67
    \item Ganho: 35 dias × R\$ 116,67 = R\$ 4.083,45
\end{itemize}
\end{estrategiaCJP}
...
\textbf{Ganho médio:} 15-90 dias adicionais (R\$ 1.500 a R\$ 10.000)

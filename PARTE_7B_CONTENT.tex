...
\begin{itemize}
    ...
    \item INSS paga a partir do \textbf{16º dia}
...
\begin{itemize}
    \item \textbf{Média A:} Media de TODOS os salários do PBC (Jul/1994 → DER)
...
\textbf{CÁLCULO:}
\begin{verbatim}
Média histórica (15 anos): R$ 3.800
Média 12 últimos: R$ 4.400
MENOR: R$ 3.800
SB: R$ 3.800
RMI: R$ 3.800 × 91% = R$ 3.458,00
\end{verbatim}

\textbf{PERÍODO:}
\begin{itemize}
    \item Primeiros 15 dias: Empresa paga salário integral
    \item A partir do 16º dia: INSS paga R\$ 3.458
...
CÁLCULO:
• Média histórica (20 anos): R$ 5.200
• Média 12 últimos: R$ 5.800
• MENOR: R$ 5.200
• SB: R$ 5.200
• RMI: R$ 5.200 × 91% = R$ 4.732,00
...
\textbf{Solução:} Art. 60, §3º, Lei 8.213/91 → Empresa DEVE pagar (se não pagar, ação trabalhista)
\end{armadilha}
...
\begin{itemize}
    ...
    \item[$\square$] INSS paga a partir do 16º dia?
...
A piora clínica ainda pode gerar REDUÇÃO de renda. Um segurado pode ter AIT de R\$ 4.550 e, ao piorar para incapacidade permanente, receber AIP de apenas R\$ 3.000.
...
\subsection{Estratégia Alternativa: Nexo Causal (B32 → B92)}

A \textbf{única via para obter 100\%} é demonstrar origem ocupacional da doença.

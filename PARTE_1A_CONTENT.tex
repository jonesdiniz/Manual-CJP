...
\begin{center}
{\large\bfseries © 2026 Jones Weslley Bueno Diniz}\\[0.3cm]
...
\begin{center}
\begin{tabular}{cl}
\xmark & Tema 1300 STF — Tese REJEITADA (6×5) \\
...
%% ============================================================================
%% MÓDULO 0: INTRODUÇÃO AO SISTEMA CJP
%% ============================================================================
\clearpage
...
Valor do primeiro pagamento do benefício. Fórmula: RMI = SB × Coeficiente.
...
\textbf{Tema 1300 STF}\\
Repercussão geral (RE 1.469.150) que analisou a constitucionalidade do coeficiente reduzido (60\%+2\%) para aposentadoria por incapacidade permanente não acidentária. \textbf{Resultado final (Dezembro/2025): 6×5 pela CONSTITUCIONALIDADE} - tese rejeitada. O coeficiente de 60\%+2\% foi mantido. \textbf{NÃO há revisão disponível}.
...
\begin{itemize}
    \item Aposentadoria por Tempo: SB × Fator Previdenciário (se vantajoso)
    \item Aposentadoria por Idade: SB × (70\% + 1\% por ano de contribuição)
\end{itemize}
...
\textbf{DOCUMENTAÇÃO CONDICIONAL}
\begin{itemize}
...
\begin{itemize}
    ...
    \item[$\square$] AIP pós-2019? → Verificar Tema 1300
    \item[$\square$] Processo judicial em curso? → Tema 1124
\end{itemize}
\end{acaoImediata}
